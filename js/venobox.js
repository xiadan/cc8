          ...
          var option = $.extend(defaults, options);
            ...
            return this.each(function() {
                  ...
                  obj.click(function(e){
                    ...
                    $('body').addClass('vbox-open no-scroll');
                    $('.header').addClass('header-fixed');
                    $('html').addClass('no-scroll');
                    $('.warp').removeClass('index-pushed');
                    $('.container').removeClass('index-pushed');
                    $('.header-menu').removeClass('is-open');
                    core = '<div class="vbox-overlay ' + extraCss + '" style="background:'+ overlayColor +'"><div class="vbox-container"><div class="vbox-content"></div></div><div class="vbox-next">next</div><div class="vbox-prev">prev</div></div>';
                    ...
                    function closeVbox(){
                      ...
                      $('body').removeClass('vbox-open no-scroll');
                    ...
                    $(document).on("click", closeclickclass, function(e){
                      ...
                      if(!$(e.target).is(evitacontent) && !$(e.target).is(evitanext) && !$(e.target).is(evitaprev)&& !$(e.target).is(figliall)){
                        closeVbox();
                      } else if ($(e.target).hasClass(needClose)) {
                        closeVbox();
                      }
                    });
